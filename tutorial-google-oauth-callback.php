...
<?php
// Config
$redirect = "https://binamsen.github.io/tutorial-google-oauth-callback"; // Enter your API Callback URL here
$client_id = "178634833998-lblb5snk55ke9c1ftm0rn9sglbqe6mh6.apps.googleusercontent.com"; // Enter your API Client ID Here
$client_secret = "Mt3D9uDOF04OjdxLnuDd5zqt"; // Enter your API Client Secret here
// Check Code
if(empty($_GET['code'])) {
	// Authorization Link
